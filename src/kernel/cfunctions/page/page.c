...
static uint64_t pages_free = 0;
static uint64_t pages_total = 0;

static uint64_t *freemap = 0;
static uint64_t freemap_bits = 0;
static uint64_t freemap_bytes = 0;
static uint64_t freemap_cells = 0;
static uint64_t freemap_pages = 0;
